...
function restaurante_add_stylesheets(){
    ...
    wp_enqueue_style( 'restaurante-restaurant-bootstrap', get_template_directory_uri()
        .'/css/bootstrap.min.css','','','all' );

    wp_enqueue_style( 'restaurante-restaurantbootstrap-theme', get_template_directory_uri()
        .'/css/bootstrap-theme.min.css','','','all' );

    wp_enqueue_style( 'restaurante-restaurant-fontawesome', get_template_directory_uri()
        .'/css/font-awesome.min.css','','','all' );


    wp_enqueue_style( 'restaurante-montserrat', get_template_directory_uri()
        .'/fonts/Montserrat-Font/stylesheet.css','','','all' );

    wp_enqueue_style( 'restaurante-kaushan', get_template_directory_uri()
        .'/fonts/Kaushan-Script-Font/stylesheet.css','','','all' );


    /*************************************************************************/

    wp_enqueue_style('restaurante-restaurant-animate',get_template_directory_uri()
        .'/css/animate.min.css','','all');



    wp_enqueue_style('restaurante-restaurant-blog',get_template_directory_uri()
        .'/css/blog.css','','all');

    wp_enqueue_style('restaurante-restaurant-slicknav',get_template_directory_uri()
        .'/css/slicknav.css','','all');


    wp_enqueue_style('restaurante-restaurant-magnific-popupcss',get_template_directory_uri()
...
function restaurante_add_scripts(){
    ...
    wp_enqueue_script('restaurante-restaurant-bootstrap', get_template_directory_uri()
        .'/js/bootstrap .min.js',
        array('jquery'),'',true);
    ...
    *******************----- Scripts ----******************************/
    ...
    wp_enqueue_script('restaurante-restaurant-slicknav', get_template_directory_uri()
        .'/js/jquery.slicknav.min.js',
        array('jquery'),'',true);


    wp_enqueue_script('restaurante-restaurant-matchHeight', get_template_directory_uri()
    ...
    wp_enqueue_script('restaurante-restauranttheme-js', get_template_directory_uri()
        .'/js/init.js',
        array('jquery'),'',true);
}
